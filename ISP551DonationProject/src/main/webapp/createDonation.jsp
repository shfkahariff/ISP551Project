  ...
  <header>
    ...
    <div class="testbox">
      <form action="addDonationController" method="post">
        ...
        <div class="colums">
          <div class="item">
            <label for="id">Donation ID<span>*</span></label>
            <input id="id" type="text" name="id" placeholder="DOXXXXXX" required/>
          </div>
          <div class="item">
            <label for="type">Donation Type<span>*</span></label>
            <select>
              <option value=""></option>
              <option value="1">Anak Yatim</option>
              <option value="2">Asnaf</option>
              <option value="3">Mualaf</option>
          ...
          <div class="item">
            ...
            <input id="total" type="number" name="total" min="1" step="any" required/>
          </div>
